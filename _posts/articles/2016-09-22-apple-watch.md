...
[^3]:	Ultimately, there's not a lot you can do within WatchOS 1.0. The software is limited to displaying apps that do all of their processing on your phone, which ultimately means that you spend waiting for apps to launch, waiting for data to be refreshed, waiting for calculations to be performed. It's not a good experience.
